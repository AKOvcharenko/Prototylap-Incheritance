...
1. Object.prototype.toString should returns
    ```js
        `Big Brother watching You! ${default method result}`
    ```
...
2. Hero instance should has methods:
    - greet: returns sting - hello there! my name is `name`, and I am `team`'s team member.
    - kickAsses: returns sting - I kick asses with power `power`.
    - manageTheTeam: returns sting - I manage `team` team, with experience `exp`.
...
2. Wuss Class instance should inherits SuperHero Class, and should has methods:
    - greet: returns sting - hello there! my name is `name`, and I am `team`'s team member.
    - kickAsses: returns sting - I can not kick asses :C my power is `power`.
    - manageTheTeam: returns sting - I manage `team` team, with experience `exp`.
...
2. Berserker Class instance should inherits SuperHero Class, and should has methods:
    - greet: returns sting - hello there! my name is `name`, and I am `team`'s team member.
    - kickAsses: returns sting - I can not kick asses :C my power is `power`.
    - manageTheTeam: returns sting - I can not manage team, I am too strong for this, my power is `power`.
...
2. Imba Class instance should inherits SuperHero Class, and should has methods:
    ...
    - kickAsses: returns sting - I kick asses with power `power`.
    - manageTheTeam: returns sting - I manage `team` team, with experience `exp`.
    -doAnything: returns sting - I can do anything, because I am imba.
